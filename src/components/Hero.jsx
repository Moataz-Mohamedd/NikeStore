     ...
     <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className=' relative opacity-100 z-20 grid items-center justify-items-center nike-container' >
            <div className='grid items-center justify-items-center mt-28 md:mt-24 '>
                ...
                <h1 className='text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text2xl 
                ...
                <div className='grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh]
                                left-[11vh] xl:left-0 w-auto h-auto '>
            ...
            <div className=''>
                <img 
                    ...
                    className='w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] 
                               -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill transitions-theme'
                />
            </div>
        </div>
